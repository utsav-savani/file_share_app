...
class _MyAudioList extends State<MyAudioList>{
  ...
  void getFiles() async { //asyn function to get list of files
    ...
    files = await fm.filesTree(
        ...
        extensions: ["doc","xlxs","pdf","ppt","pptx","txt"] //optional, to filter files, list only mp3 files
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title:Text("Documents list from Storage"),
          ...
          itemBuilder: (context, index) {
            return Card(
                child:ListTile(
                  ...
                  trailing: Icon(Icons.file_copy_sharp, color: Colors.redAccent,),
                  onTap: (){
