...
@immutable
class MyPhotosList extends StatefulWidget {
  @override
  _MyPhotosListState createState() => _MyPhotosListState();
}

class _MyPhotosListState extends State<MyPhotosList> {
  @override
                              ...
                              itemBuilder: (context, index) => Card(
                                  child: CheckboxListTile(
                                    ...
                                    FittedBox(
                                      child: Row(
                                        children: [
                                          SvgPicture.asset("assets/icons/photos.svg",height: 40,),
                                          SizedBox(
                                            width: 10,
                                          ),
                                          Text(
